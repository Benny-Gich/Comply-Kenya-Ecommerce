            ...
            {open && (
                <div className="bg-white rounded-xl shadow-xl p-4 w-64 border border-gray-100">
                    <div className="flex items-center gap-3 mb-3">
                        ...
                        <div>
                            <p className="font-semibold text-gray-800 text-sm">Comply Kenya</p>
                            <p className="text-xs text-green-500">Online now</p>
                        </div>
                    </div>
                    <p className="text-sm text-gray-600 mb-3">
                        Hi! How can we help you today? Chat with us on WhatsApp.
                    </p>
                    <button
                        onClick={handleOpen}
                        className="w-full bg-green-500 hover:bg-green-600 text-white text-sm font-medium py-2 rounded-lg transition"
                    >
                        Start Chat
                    </button>
                </div>
