...
import { adminSignInWithGoogle, adminSignInWithApple, resolveAdminRedirectResult } from '../../services/socialAuth.service';
...
const AdminLogin = () => {
    ...
    const handleSocialSignIn = (provider) => {
        ...
        const signIn = provider === 'google' ? adminSignInWithGoogle : adminSignInWithApple;
        signIn().catch((err) => {
            setSocialLoading('');
            ...
            <div className="w-full max-w-md">
                ...
                <div className="bg-white rounded-2xl shadow-lg p-8 space-y-5">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <button type="submit" className="btn-primary w-full" disabled={loading || !!socialLoading}>
